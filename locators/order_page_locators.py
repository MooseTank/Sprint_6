...
class OrderPageLocators:
    ...
    title_order_page = By.XPATH, "//div[text()='Для кого самокат' and contains(@class, 'Order_Header')]"
    ...
    # Страница "Про аренду"
    title_rent_info_page = By.XPATH, "//div[text()='Про аренду' and contains(@class, 'Order_Header')]"
