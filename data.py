class TestData:
    test_data_user_1 = ['Кофа', 'Йох', 'Старых монеток, 4', 'Черкизовская', '+79647521204', '09.05.2025', 'Пора в дорогу']
    test_data_user_2 = ['Луукфи', 'Пенц', 'Желтых камней, 16', 'Лубянка', '+79032004442', '15.05.2025', 'Едем в управление Полного порядка']
